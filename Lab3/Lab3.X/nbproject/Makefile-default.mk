...
SOURCEFILES_QUOTED_IF_SPACED=lab_3.c LCD.c ADC.c USART.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/lab_3.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/USART.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/lab_3.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/USART.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/lab_3.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/USART.p1

# Source Files
SOURCEFILES=lab_3.c LCD.c ADC.c USART.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lab_3.p1: lab_3.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab_3.p1.d 
	@${RM} ${OBJECTDIR}/lab_3.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/lab_3.p1 lab_3.c 
	@-${MV} ${OBJECTDIR}/lab_3.d ${OBJECTDIR}/lab_3.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/lab_3.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
